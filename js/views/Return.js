...
export default class extends General{
	constructor(){
		...
		this.setTitle('Return::Lifesytle Outdoorgear');
	}

	async getPage(){
		return `
		<section class="page" id="return">
			<div class="our_products">
				<div class="heading">
					<label><i class="las la-list"></i> Returned Items </label>
				...
				<table class="inventory_list">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<label>
									<span class="status s_active">returned</span>
								</label>
							</td>
